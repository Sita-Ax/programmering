...
public class Game implements ActionListener {
	...
	//	for (int i = 0; i < 7; i++) {
			...
			icon[0] = new ImageIcon("/card/1.jpg");
//			icon[1] = new ImageIcon("/card/2.jpg");
//			icon[2] = new ImageIcon("/card/3.jpg");
//			icon[3] = new ImageIcon("/card/4.jpg");
//			icon[4] = new ImageIcon("/card/5.jpg");
//			icon[5] = new ImageIcon("/card/6.jpg");
//			icon[6] = new ImageIcon("/card/7.jpg");
			System.out.println("ico 7st" +icon[0]);
//		}
		return icon;
	}
	...
	public JPanel makeCards() {
		...
		ImageIcon backIcon = this.cardIcon[0];
		...
		for (int i = 0; i < cardToAdd.length; i++) {
			...
			Card newCard = new Card(controller, this.cardIcon[number], backIcon, number);
